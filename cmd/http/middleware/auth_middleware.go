...
type (
	authService interface {
		ProcessToken(ctx context.Context, reqToken string) (*domain.User, error)
	}
...
func (am *AuthMiddleware) MustHavePermissionMiddleware(permissions ...domain.UserPermission) gin.HandlerFunc {
	return func(c *gin.Context) {
